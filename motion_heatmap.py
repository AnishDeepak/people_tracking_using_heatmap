...
def main():
    ...
    #capture=cv2.VideoCapture('rtsp://10.10.5.200:554/user=admin&password=&channel=1&stream=1.sdp?')
    ...
    for i in range(0, length):
        ...
        if first_iteration_indicator == 1:
            ...
            cv2.imwrite('frames/diff-bkgnd-frame.jpg', filter)
            ...
            cv2.imwrite('frames/mask.jpg', accum_image)
